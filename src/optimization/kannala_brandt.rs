...
use super::kannala_brandt_factor::KannalaBrandtProjectionFactor;
use super::Optimizer;
...
impl KannalaBrandtOptimizationCost {
    /// Optimizes the Kannala-Brandt camera model parameters using apex-solver.
    ///
    ...
    pub fn optimize_with_apex(&mut self, verbose: bool) -> Result<(), CameraModelError> {
        ...
        let projection_factor = KannalaBrandtProjectionFactor::new(points_3d_vec, points_2d_vec);
        ...
        // Initial camera parameters: [fx, fy, cx, cy, k1, k2, k3, k4]
        let initial_params = DVector::from_vec(vec![
            self.model.intrinsics.fx,
            self.model.intrinsics.fy,
            self.model.intrinsics.cx,
